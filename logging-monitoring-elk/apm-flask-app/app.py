...
#tracer = Tracer(config={"server_url":"http://172.23.0.1:8200","service_name":"ap-mflask"});
...
elasticapm.set_user_context(username='ab-anand', email='abhinav@xyz.com', user_id=1234)
...
app = Flask(__name__)
apm = ElasticAPM(app, server_url='http://172.30.0.1:8200', service_name='my-app-01', logging=False)
...
@app.route('/node')
def google():
    return redirect("http://172.17.0.1:8081")
